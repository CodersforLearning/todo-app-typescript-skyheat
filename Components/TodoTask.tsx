  ...
  return (
    <div className='w-[500px] h-[50px] flex text-black m-15px mt-8'>
        <div className='flex-[80%] h-full flex justify-center items-center'>
            <span className='grid place-items-center border-none w-full h-full text-lg bg-neutral-200'>{task.taskName}</span>
            <span className='grid place-items-center border-none w-full h-full text-lg bg-neutral-200'>{task.deadline}</span>
        </div>
